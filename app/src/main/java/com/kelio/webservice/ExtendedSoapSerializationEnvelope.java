...
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://lang.java^^Throwable", Throwable.class);
        classNames.put("http://lang.java^^Exception", Exception.class);
        classNames.put("http://echange.service.open.bodet.com^^Clocking", Clocking.class);
        classNames.put("http://echange.service.open.bodet.com^^EmployeeInformation", EmployeeInformation.class);
        classNames.put("http://echange.service.open.bodet.com^^Object", Object.class);
        classNames.put("http://echange.service.open.bodet.com^^AskedPopulationWithPeriod", AskedPopulationWithPeriod.class);
        classNames.put("http://echange.service.open.bodet.com^^AskedPopulation", AskedPopulation.class);
        classNames.put("http://echange.service.open.bodet.com^^askedEmployee", AskedEmployee.class);
        classNames.put("http://echange.service.open.bodet.com^^ArrayOfClocking", ArrayOfClocking.class);
        classNames.put("http://echange.service.open.bodet.com^^ArrayOfAskedPopulationWithPeriod", ArrayOfAskedPopulationWithPeriod.class);
        classNames.put("http://echange.service.open.bodet.com^^ArrayOfAskedEmployee", ArrayOfAskedEmployee.class);
    } 
    ...
    private java.lang.Object createObject(java.lang.Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        java.lang.Object obj=cl.newInstance();
        Method ctor = obj.getClass().getMethod("loadFromSoap", java.lang.Object.class, ExtendedSoapSerializationEnvelope.class);
