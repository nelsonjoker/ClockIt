...
*/
    ...
    public static void registerDataPreserver(Context c, TimeDataPreserver.OnUpdateRequiredListener listener) {
        if(preserver == null) {
            preserver = new TimeDataPreserver(persistence, listener);
